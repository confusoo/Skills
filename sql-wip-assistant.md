---
name: sql-wip-assistant
description: Generates a ready-to-use INSERT statement for the WIP_USER table. Prompts the user one by one for username, email, name, fee, and currency.
parameters: []
---
...
- The NULL values on the final query must be kept. Do not alter anything that does not come from the user.